...
//    @Override
//    public void handleBook(BookAddEventDto addEventDto) {
//        if (addEventDto.getChange().equals("add")) {
//            saveBook(addEventDto.getBookDto());
//        } else if (addEventDto.getChange().equals("delete")) {
//            deleteBookById(addEventDto.getBookDto().getIsbn());
//        } else if (addEventDto.getChange().equals("update")) {
//            // int quantity=0;
//            Optional<Book> optional = bookRepository.findById(addEventDto.getBookDto().getIsbn());
//            if (optional.isPresent()) {
//                Book book = optional.get();
//                // quantity=product.getNumberInStock();
//            }
//            updateBook(addEventDto.getBookDto().getIsbn(), new BookDto(
//                    addEventDto.getBookDto().getIsbn(),
//                    addEventDto.getBookDto().getTitle(),
//                    addEventDto.getBookDto().getDescription(),
//                    addEventDto.getBookDto().getAuthorName(),
//                    addEventDto.getBookDto().getReview()));
